...
If two chains have strong Smart Contract support, once can build a trustless bridge using a zk-SNARK proof in between. If you'd like to learn more about how zk-SNARKs work, [check out this blog]({{< relref "2022-07-05-Zk-SNARKs-A-Primer.md" >}})
